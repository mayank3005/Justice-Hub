...
const Newsletter = () => {
  ...
  return (
    <div>
      ...
      <div className='texxt2'>Discover the latest laws and rules on the daily basis via the email lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem</div>
      <div >
